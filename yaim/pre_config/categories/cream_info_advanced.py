...
def get(data, id):
    ...
    advanced_category.add_key_value_query("globus_tcp_port_range", globus_tcp_port_range(component_section))
    advanced_category.add_key_value_query("vos", vos(component_section, data)) #additional
